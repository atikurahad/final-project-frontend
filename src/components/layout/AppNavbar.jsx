    ...
    <>
        ...
        <NavLink
          className={({ isActive }) =>
            isActive
              ...
              : "text-lg font-medium mt-3 lg:mt-0 lg:mx-5"
          }
          to={"/"}
        >
          Home
          ...
          <NavLink
            className={({ isActive }) =>
              isActive
                ...
                : "text-lg font-medium lg:mr-5  mt-3 lg:mt-0"
            }
            to={"/products"}
          >
            Products
      ...
      {isLogin() ? (
        ...
        <motion.button
          ...
          onClick={handleLogin}
          className={
            "btn btn-md btn-primary max-w-[100px] text-white font-semibold rounded-xl " +
  ...
  return (
    <div className="navbar shadow-2xl px-5 py-3 fixed top-0  z-50 max-w-screen-2xl w-full bg-base-100">
      <div className="navbar-start">
        ...
        <Link to={"/"} className="">
          <h1 className="text-2xl font-bold text-primary">WomenFashion</h1>
        </Link>
      </div>
